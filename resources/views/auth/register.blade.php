                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" aria-describedby="nameHelp" placeholder="{{ __('user.name_hint')}}" required autofocus>
                                <small id="nameHelp" class="form-text text-muted">{{ __('user.name_expl')}}</small>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('user.password_confirm') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" aria-describedby="emailHelp">
                                <small id="emailHelp" class="form-text text-muted">{{ __('user.email_expl')}}</small>
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
